...
import com.sample.photogallery.PhotoInterceptor
import com.sample.photogallery.PhotoResponse
...
class FlickrFetchr {
    ...
    fun searchPhotos(query: String):
            LiveData<List<GalleryItem>> { return fetchPhotoMetadata(flickrApi.searchPhotos(query
        ))
    }
